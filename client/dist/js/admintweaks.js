  ...
  $.entwine('ss', function ($) {
    ...
    $('input.styled-checkbox').entwine({
      onadd: function onadd(e) {
        ...
        this.addClass('styled-checkbox-hide').after($('<label></label>').attr({
          "for": this.attr('id')
        }));
        this._super();
      }
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkrestruct_silverstripe_admintweaks"] = self["webpackChunkrestruct_silverstripe_admintweaks"] || [];
...
/******/ })()
;
//# sourceMappingURL=admintweaks.js.map